...
class QueryParser(object):
    ...
    # query.i:records=modified&query.o:records=between&
    #query.v:records:list=2009/08/12&query.v:records:list=2009/08/14
    # v[0] >= x > v[1]
    ...
    # query.o:records=less_then&query.v:records=2009/08/14
    # x < value
    ...
    # query.i:records=modified&
    # query.o:records=less_then_relative_date&query.v:records=-7
    ...
    # query.i:records=modified
    # &query.o:records=more_then_relative_date&query.v:records=-2
    ...
    # &query.o:records=path&query.v:records=/search/news/
    ...
    # query.i:records=path&
    # query.o:records=relative_path&query.v:records=../../..
